    ...
    return (
        <div className="p-6 space-y-6">
            <header className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter text-slate-900">Sales Dashboard</h1>
                    <p className="text-slate-500 font-medium tracking-tight">February 2026 — Kerala Territory Revenue</p>
                </div>
                <Button variant="ghost" size="icon" className="h-12 w-12 bg-white border border-slate-100 rounded-xl shadow-sm hover:bg-slate-50 transition-colors relative">
            ...
            <Card className="border-none bg-gradient-to-r from-slate-900 to-slate-800 text-white relative overflow-hidden shadow-xl shadow-slate-900/40 rounded-3xl">
